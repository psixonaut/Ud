...
urlpatterns = [
    ...
    # --- ПРОДАЖИ (Вот тут была ошибка) ---
    path('sales/', views.sale_list, name='sale_list'),
    path('sales/new/', views.create_sale, name='create_sale'),
    path('sales/<int:sale_id>/', views.sale_detail, name='sale_detail'),  # <--- ДОБАВЛЕНО
...
# КЛИЕНТЫ
    ...
    path('clients/new/', views.add_client, name='add_client'),         # <--- Новый
    path('clients/<int:passport_id>/delete/', views.delete_client, name='delete_client'), # <--- Новый
]